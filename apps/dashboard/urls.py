...
urlpatterns = patterns('',
	...
	url(r'ewi_macro_gaps/$', TemplateView.as_view(template_name='dashboard/A2_ewi_macro_gaps.html')),
	url(r'noise_liquidity/$', TemplateView.as_view(template_name='dashboard/F3_noise_liquidity.html')),
